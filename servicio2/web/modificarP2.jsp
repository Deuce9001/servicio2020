    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="container">
        ...
        <p>
          ...
          <a class="btn btn-primary btn-lg" href="darDeBajP.jsp" >Dar de Baja »</a>
          ...
          <div class="col-lg-6">
            <div class="well bs-component">
              <form class="form-horizontal">
                <fieldset>
                    <legend>Modificar Personal</legend>
			...
			onSelect	 : selectDate
                    ...
                    <br>
                     <div class="form-horizontal">
                      ...
                      <div class="checkbox">
                        <label>
                          <input type="checkbox"> Curriculum
                        </label>                          
                      </div>                
...
<div class="form-horizontal">
			...
			<input id="posicion" name= "tel1" class="element text" maxlength="8" size="30" value=""/>
