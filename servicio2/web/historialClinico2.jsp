...
var IDvaluesOfEachDiv = "generar modificar";
...
ShowContent(d);
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
      ...
      <div class="container">
        ...
        <p>
          <a class="btn btn-primary btn-lg" href="javascript:HideAllShowOne('generar')" >Generar »</a>
      ...
      <div class="bs-docs-section">
        <div class="row">
            <div class="col-lg-12" id="historialClinico2" >
