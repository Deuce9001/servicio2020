                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="well bs-component">
                                ...
                                <form class="form-horizontal" method="post" action="AltaHorario">
                                    <fieldset>
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            &nbsp;
                                            <span>
                                                <input id="element_2_1" name="horaE" class="element text " size="2" type="text" maxlength="2" value=""/> : 
                                                <label>HH</label>
                                            </span>
                                            <span>
                                                <input id="element_2_2" name="minutoE" class="element text " size="2" type="text" maxlength="2" value=""/> : 
                                                <label>MM</label>
                                            </span>
                                            &nbsp;
                                            <span>
                                                <select class="element select" style="width:4em" id="element_2_4" name="tiempoE">
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            &nbsp;
                                            <span>
                                                <input id="element_2_1" name="horaS" class="element text " size="2" type="text" maxlength="2" value=""/> : 
                                                <label>HH</label>
                                            </span>
                                            <span>
                                                <input id="element_2_2" name="minutoS" class="element text " size="2" type="text" maxlength="2" value=""/> : 
                                                <label>MM</label>
                                            </span>
                                            &nbsp;
                                            <span>
                                                <select class="element select" style="width:4em" id="element_2_4" name="tiempoS">
                                                    <option value="am" >AM</option>
                                                    <option value="pm" >PM</option>
                                                </select>
                                                <label>AM/PM</label>
                                        ...
                                        <div class="form-horizontal">
                                            <div class="form-group">
                                                ...
                                                <br/>
                                                <div class="col-lg-10">
                                                    <textarea class="form-control" rows="3" id="textArea" name="dias">Lunes, Martes, Miércoles, Jueves, Viernes</textarea>
                                                </div>
                                            </div>  
                                        </div>                
