        ...
        <div class="bs-docs-section">
            <div class="row">
                ...
                <div class="page-header">
                    <h1 id="tables">Modificar Alumno</h1>
                </div>
                                ...
                                <form class="form-horizontal" method="post" action="ModificaNino">
                                    <fieldset>
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            &nbsp;
                                            <span>
                                                <input type="text" id="matricula" name="matricula" class="element text" value="${sessionScope.matricula}" size="7" maxlength="7" required="required"/>
                                            </span>
                                            <br>
                                            <br>
                                            ...
                                            &nbsp;
                                            <span>
                                                <input type="text" id="element_1_1" name="nombre" class="element text" maxlength="255" size="56" value="${nino.nombre}"/> 
                                            </span>
                                        </div>
                                        <br>
                                        <br>
                                        ...
                                        &nbsp;
                                        <span>
                                            <input type="text" id="element_3_1" name="mes" class="element text" size="2" maxlength="2" value="${nino.mes}"/>
                                                <label for="element_3_1">MM</label>
                                        </span>
                                        <span>
                                            <input type="text" id="element_3_2" name="dia" class="element text" size="2" maxlength="2" value="${nino.dia}"/>
                                                <label for="element_3_2">DD</label>
                                        </span>
                                        <span>
                                            <input type="text" id="element_3_3" name="anio" class="element text" size="4" maxlength="4" value="${nino.anio}"/>
                                        ...
                                        <div class="form-horizontal">
                                            ...
                                            <input type="text" id="telefono" name="telefono" class="element text" maxlength="10" size="10" value="${nino.telefono}"/>
                                        </div>
                                        <br>
                                        <div class="form-horizontal">
